...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "language": "c",
        "name": "girth.bmssp_core",
        "sources": [
            "girth/bmssp_core.pyx"
        ]
    },
    "module_name": "girth.bmssp_core"
}
END: Cython Metadata */
...
#define __PYX_HAVE__girth__bmssp_core
#define __PYX_HAVE_API__girth__bmssp_core
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "girth.bmssp_core" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "girth.bmssp_core"
extern int __pyx_module_is_main_girth__bmssp_core;
int __pyx_module_is_main_girth__bmssp_core = 0;

/* Implementation of "girth.bmssp_core" */
...
static const char __pyx_k_relax_batch[] = "relax_batch";
static const char __pyx_k_is_coroutine[] = "_is_coroutine";
static const char __pyx_k_class_getitem[] = "__class_getitem__";
static const char __pyx_k_girth_bmssp_core[] = "girth.bmssp_core";
static const char __pyx_k_asyncio_coroutines[] = "asyncio.coroutines";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_girth_bmssp_core_pyx[] = "girth/bmssp_core.pyx";
static const char __pyx_k_0_Q_XT_Qc_3b_q_Cxt6_T_Qj_Ba_s_R[] = "\200\001\3600\000\005\t\210\005\210Q\330\010\r\210X\220T\230\024\230Q\230c\240\021\330\010\013\2103\210b\220\001\330\014\r\340\010\017\210q\220\001\220\021\340\010\014\210C\210x\220t\2306\240\021\330\014\025\220T\230\024\230Q\230j\250\001\330\014\021\220\023\220B\220a\330\014\017\210s\220#\220R\220t\2303\230b\240\004\240D\250\001\250\023\250A\330\020\024\220A\220U\230!\330\020\024\220A\220U\230!\330\020\025\220Q\220e\2305\240\001\240\023\240B\240a\330\020\022\220'\230\021\230$\230a";
static const char __pyx_k_Cython_accelerated_core_relaxati[] = "Cython-accelerated core relaxation routine for BMSSP.\n\nThis file is a minimal drop-in replacement for the Python edge-relaxation loop\ninside `girth.bmssp_full.BMSSPFullStrategy._bmssp`.  It keeps the original data\nstructures (plain Python `dict`s, NetworkX `Graph`, and the existing\n`BlockBasedPQ`) so no higher-level code needs to change.  Even with Python\nobjects, executing the innermost loop in C reduces interpreter overhead and\nprovides a 2-3\303\227 speed-up on \342\211\2452 k-node graphs (profiling numbers in README).\n\nNotes\n-----\n1.  We do *not* depend on NumPy \342\200\223 pure Python and NetworkX only.\n2.  The routine is written as a `def` (not `cpdef`) so it can be called\n    seamlessly from regular Python.  If the compiled extension is missing the\n    import will fail gracefully and BMSSP falls back to the original pure-\n    Python loop.\n";
static const char __pyx_k_Note_that_Cython_is_deliberately[] = "Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5girth_10bmssp_core_relax_batch(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nodes, PyObject *__pyx_v_dist, PyObject *__pyx_v_pred, PyObject *__pyx_v_depth, PyObject *__pyx_v_G, double __pyx_v_B_i, double __pyx_v_B, PyObject *__pyx_v_pq); /* proto */
...
#define __pyx_n_u_B_i __pyx_string_tab[2]
...
#define __pyx_n_u_depth __pyx_string_tab[10]
#define __pyx_n_u_dist __pyx_string_tab[11]
#define __pyx_n_u_du __pyx_string_tab[12]
#define __pyx_n_u_func __pyx_string_tab[13]
#define __pyx_n_u_get __pyx_string_tab[14]
#define __pyx_n_u_girth_bmssp_core __pyx_string_tab[15]
#define __pyx_kp_u_girth_bmssp_core_pyx __pyx_string_tab[16]
#define __pyx_n_u_insert __pyx_string_tab[17]
...
#define __pyx_n_u_nbrs __pyx_string_tab[23]
#define __pyx_n_u_nd __pyx_string_tab[24]
#define __pyx_n_u_nodes __pyx_string_tab[25]
#define __pyx_n_u_pop __pyx_string_tab[26]
#define __pyx_n_u_pq __pyx_string_tab[27]
#define __pyx_n_u_pred __pyx_string_tab[28]
#define __pyx_n_u_qualname __pyx_string_tab[29]
#define __pyx_n_u_relax_batch __pyx_string_tab[30]
#define __pyx_n_u_set_name __pyx_string_tab[31]
#define __pyx_n_u_test __pyx_string_tab[32]
#define __pyx_n_u_u __pyx_string_tab[33]
#define __pyx_n_u_v __pyx_string_tab[34]
#define __pyx_n_u_weight __pyx_string_tab[35]
...
/* Python wrapper */
static PyObject *__pyx_pw_5girth_10bmssp_core_1relax_batch(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_5girth_10bmssp_core_relax_batch, "Relax outgoing edges for all *nodes*.\n\n    Parameters\n    ----------\n    nodes : iterable of hashable\n        Vertex ids whose outgoing edges should be relaxed.\n    dist, pred, depth : dict\n        Data structures updated in-place.  Same semantics as in\n        `BMSSPFullStrategy`.\n    G : networkx.Graph\n        The graph (undirected / directed) providing adjacency and weights.\n    B_i : float\n        Local bound (distance threshold for this batch).\n    B : float\n        Global bound \342\200\223 distances above this value are disregarded.\n    pq : BlockBasedPQ\n        Priority queue used by BMSSP recursion.\n    ");
static PyMethodDef __pyx_mdef_5girth_10bmssp_core_1relax_batch = {"relax_batch", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5girth_10bmssp_core_1relax_batch, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5girth_10bmssp_core_relax_batch};
static PyObject *__pyx_pw_5girth_10bmssp_core_1relax_batch(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("relax_batch (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_nodes,&__pyx_mstate_global->__pyx_n_u_dist,&__pyx_mstate_global->__pyx_n_u_pred,&__pyx_mstate_global->__pyx_n_u_depth,&__pyx_mstate_global->__pyx_n_u_G,&__pyx_mstate_global->__pyx_n_u_B_i,&__pyx_mstate_global->__pyx_n_u_B,&__pyx_mstate_global->__pyx_n_u_pq,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "relax_batch", 0) < 0) __PYX_ERR(0, 26, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 8; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("relax_batch", 1, 8, 8, i); __PYX_ERR(0, 26, __pyx_L3_error) }
      }
    ...
    __pyx_v_dist = ((PyObject*)values[1]);
    __pyx_v_pred = ((PyObject*)values[2]);
    __pyx_v_depth = ((PyObject*)values[3]);
    __pyx_v_G = values[4];
    __pyx_v_B_i = __Pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_B_i == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("relax_batch", 1, 8, 8, __pyx_nargs); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("girth.bmssp_core.relax_batch", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dist), (&PyDict_Type), 1, "dist", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pred), (&PyDict_Type), 1, "pred", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_depth), (&PyDict_Type), 1, "depth", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_r = __pyx_pf_5girth_10bmssp_core_relax_batch(__pyx_self, __pyx_v_nodes, __pyx_v_dist, __pyx_v_pred, __pyx_v_depth, __pyx_v_G, __pyx_v_B_i, __pyx_v_B, __pyx_v_pq);
...
static PyObject *__pyx_pf_5girth_10bmssp_core_relax_batch(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nodes, PyObject *__pyx_v_dist, PyObject *__pyx_v_pred, PyObject *__pyx_v_depth, PyObject *__pyx_v_G, double __pyx_v_B_i, double __pyx_v_B, PyObject *__pyx_v_pq) {
  double __pyx_v_du;
  double __pyx_v_nd;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("relax_batch", 0);

  /* "girth/bmssp_core.pyx":50
...
*/
  if (likely(PyList_CheckExact(__pyx_v_nodes)) || PyTuple_CheckExact(__pyx_v_nodes)) {
    ...
    __pyx_t_2 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_nodes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
 ...
 *             continue
*/
    if (unlikely(__pyx_v_dist == Py_None)) {
      PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "get");
      __PYX_ERR(0, 51, __pyx_L1_error)
    }
    __pyx_t_4 = PyFloat_FromDouble(INFINITY); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyDict_GetItemDefault(__pyx_v_dist, __pyx_v_u, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_6 = __Pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_6 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_du = ((double)__pyx_t_6);

    /* "girth/bmssp_core.pyx":52
 *     for u in nodes:
 *         du = <double>dist.get(u, INFINITY)
 *         if du > B_i:             # <<<<<<<<<<<<<<
 *             continue
 * 
*/
    __pyx_t_7 = (__pyx_v_du > __pyx_v_B_i);
    if (__pyx_t_7) {

      /* "girth/bmssp_core.pyx":53
 *         du = <double>dist.get(u, INFINITY)
 *         if du > B_i:
 *             continue             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_v_G, __pyx_v_u); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_nbrs, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "girth/bmssp_core.pyx":57
 *         nbrs = G[u]               # adjacency mapping for *u*
 *         # Equivalent to: for v, data in G[u].items():
 *         for v, data in nbrs.items():             # <<<<<<<<<<<<<<
...
*/
    __pyx_t_8 = 0;
    if (unlikely(__pyx_v_nbrs == Py_None)) {
      PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "items");
      __PYX_ERR(0, 57, __pyx_L1_error)
    }
    __pyx_t_4 = __Pyx_dict_iterator(__pyx_v_nbrs, 0, __pyx_mstate_global->__pyx_n_u_items, (&__pyx_t_9), (&__pyx_t_10)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_XDECREF(__pyx_t_5);
    __pyx_t_5 = __pyx_t_4;
    __pyx_t_4 = 0;
    while (1) {
      __pyx_t_12 = __Pyx_dict_iter_next(__pyx_t_5, __pyx_t_9, &__pyx_t_8, &__pyx_t_4, &__pyx_t_11, NULL, __pyx_t_10);
      if (unlikely(__pyx_t_12 == 0)) break;
      if (unlikely(__pyx_t_12 == -1)) __PYX_ERR(0, 57, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
...
*/
      __pyx_t_11 = __Pyx_PyObject_GetAttrStr(__pyx_v_data, __pyx_mstate_global->__pyx_n_u_get); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 58, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_11, __pyx_mstate_global->__pyx_tuple[0], NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 58, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
 ...
 *                 dist[v] = nd
*/
      __pyx_v_nd = (__pyx_v_du + __pyx_v_weight);

      /* "girth/bmssp_core.pyx":60
 *             weight = data.get("weight", 1.0)
 *             nd = du + weight
 *             if nd <= B and nd < dist.get(v, INFINITY):             # <<<<<<<<<<<<<<
 *                 dist[v] = nd
 *                 pred[v] = u
*/
      __pyx_t_13 = (__pyx_v_nd <= __pyx_v_B);
      if (__pyx_t_13) {
      } else {
        __pyx_t_7 = __pyx_t_13;
        goto __pyx_L9_bool_binop_done;
      }
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_nd); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__pyx_v_dist == Py_None)) {
        PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "get");
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      __pyx_t_11 = PyFloat_FromDouble(INFINITY); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_14 = __Pyx_PyDict_GetItemDefault(__pyx_v_dist, __pyx_v_v, __pyx_t_11); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_11 = PyObject_RichCompare(__pyx_t_4, __pyx_t_14, Py_LT); __Pyx_XGOTREF(__pyx_t_11); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_13 = __Pyx_PyObject_IsTrue(__pyx_t_11); if (unlikely((__pyx_t_13 < 0))) __PYX_ERR(0, 60, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_7 = __pyx_t_13;
      __pyx_L9_bool_binop_done:;
      if (__pyx_t_7) {

        /* "girth/bmssp_core.pyx":61
 *             nd = du + weight
 *             if nd <= B and nd < dist.get(v, INFINITY):
 *                 dist[v] = nd             # <<<<<<<<<<<<<<
 *                 pred[v] = u
 *                 depth[v] = depth[u] + 1
*/
        __pyx_t_11 = PyFloat_FromDouble(__pyx_v_nd); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 61, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        if (unlikely(__pyx_v_dist == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
          __PYX_ERR(0, 61, __pyx_L1_error)
        }
        if (unlikely((PyDict_SetItem(__pyx_v_dist, __pyx_v_v, __pyx_t_11) < 0))) __PYX_ERR(0, 61, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;

        /* "girth/bmssp_core.pyx":62
 *             if nd <= B and nd < dist.get(v, INFINITY):
 *                 dist[v] = nd
 *                 pred[v] = u             # <<<<<<<<<<<<<<
 *                 depth[v] = depth[u] + 1
...
*/
        ...
        if (unlikely((PyDict_SetItem(__pyx_v_pred, __pyx_v_v, __pyx_v_u) < 0))) __PYX_ERR(0, 62, __pyx_L1_error)

        /* "girth/bmssp_core.pyx":63
 *                 dist[v] = nd
 *                 pred[v] = u
 *                 depth[v] = depth[u] + 1             # <<<<<<<<<<<<<<
 *                 pq.insert(nd, v)
*/
        if (unlikely(__pyx_v_depth == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
          __PYX_ERR(0, 63, __pyx_L1_error)
        }
        __pyx_t_11 = __Pyx_PyDict_GetItem(__pyx_v_depth, __pyx_v_u); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 63, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_14 = __Pyx_PyLong_AddObjC(__pyx_t_11, __pyx_mstate_global->__pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 63, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        if (unlikely(__pyx_v_depth == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
        ...
        if (unlikely((PyDict_SetItem(__pyx_v_depth, __pyx_v_v, __pyx_t_14) < 0))) __PYX_ERR(0, 63, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;

        /* "girth/bmssp_core.pyx":64
 *                 pred[v] = u
 *                 depth[v] = depth[u] + 1
 *                 pq.insert(nd, v)             # <<<<<<<<<<<<<<
*/
        __pyx_t_11 = __pyx_v_pq;
        __Pyx_INCREF(__pyx_t_11);
        __pyx_t_4 = PyFloat_FromDouble(__pyx_v_nd); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 64, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_15 = 0;
        {
          PyObject *__pyx_callargs[3] = {__pyx_t_11, __pyx_t_4, __pyx_v_v};
          __pyx_t_14 = __Pyx_PyObject_FastCallMethod(__pyx_mstate_global->__pyx_n_u_insert, __pyx_callargs+__pyx_t_15, (3-__pyx_t_15) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
...
static int __pyx_pymod_exec_bmssp_core(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bmssp_core},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "bmssp_core",
      __pyx_k_Cython_accelerated_core_relaxati, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_bmssp_core(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bmssp_core(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bmssp_core(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bmssp_core' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "bmssp_core" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_bmssp_core", 0);
  ...
  if (__pyx_module_is_main_girth__bmssp_core) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "girth.bmssp_core")) {
      if (unlikely((PyDict_SetItemString(modules, "girth.bmssp_core", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     """Relax outgoing edges for all *nodes*.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5girth_10bmssp_core_1relax_batch, 0, __pyx_mstate_global->__pyx_n_u_relax_batch, NULL, __pyx_mstate_global->__pyx_n_u_girth_bmssp_core, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_relax_batch, __pyx_t_2) < 0) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "girth/bmssp_core.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init girth.bmssp_core", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init girth.bmssp_core");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_B_i, sizeof(__pyx_k_B_i), 0, 1, 1}, /* PyObject cname: __pyx_n_u_B_i */
  ...
  {__pyx_k_girth_bmssp_core, sizeof(__pyx_k_girth_bmssp_core), 0, 1, 1}, /* PyObject cname: __pyx_n_u_girth_bmssp_core */
  {__pyx_k_girth_bmssp_core_pyx, sizeof(__pyx_k_girth_bmssp_core_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_girth_bmssp_core_pyx */
  ...
  {__pyx_k_nbrs, sizeof(__pyx_k_nbrs), 0, 1, 1}, /* PyObject cname: __pyx_n_u_nbrs */
  ...
  {__pyx_k_pred, sizeof(__pyx_k_pred), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pred */
  {__pyx_k_qualname, sizeof(__pyx_k_qualname), 0, 1, 1}, /* PyObject cname: __pyx_n_u_qualname */
  {__pyx_k_relax_batch, sizeof(__pyx_k_relax_batch), 0, 1, 1}, /* PyObject cname: __pyx_n_u_relax_batch */
 ...
 *             if nd <= B and nd < dist.get(v, INFINITY):
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(2, __pyx_mstate_global->__pyx_n_u_weight, __pyx_mstate_global->__pyx_float_1_0); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 58, __pyx_L1_error)
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {8, 0, 0, 15, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 26, 153};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_nodes, __pyx_mstate->__pyx_n_u_dist, __pyx_mstate->__pyx_n_u_pred, __pyx_mstate->__pyx_n_u_depth, __pyx_mstate->__pyx_n_u_G, __pyx_mstate->__pyx_n_u_B_i, __pyx_mstate->__pyx_n_u_B, __pyx_mstate->__pyx_n_u_pq, __pyx_mstate->__pyx_n_u_du, __pyx_mstate->__pyx_n_u_nd, __pyx_mstate->__pyx_n_u_weight, __pyx_mstate->__pyx_n_u_u, __pyx_mstate->__pyx_n_u_v, __pyx_mstate->__pyx_n_u_nbrs, __pyx_mstate->__pyx_n_u_data};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_girth_bmssp_core_pyx, __pyx_mstate->__pyx_n_u_relax_batch, __pyx_k_0_Q_XT_Qc_3b_q_Cxt6_T_Qj_Ba_s_R, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
